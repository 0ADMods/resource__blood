...
function init(data)
{
	...
	getGUIObjectByName("bloodGatheredHeading").size = left + " 34 " + (left + width) + " 100%"; left += width;
	...
	getGUIObjectByName("exchangedBloodHeading").size = left + " 16 " + (left + width) + " 100%"; left += width;
	...
	for (var i = 0; i < MAX_SLOTS; ++i)
	{
		if (i < maxPlayers)
		{
			...
			var bloodGathered = getGUIObjectByName("bloodGathered["+i+"]");
			...
			var exchangedBlood = getGUIObjectByName("exchangedBlood["+i+"]");
			...
			bloodGathered.size = left + " 2 " + (left + width) + " 100%"; left += width;
			...
			exchangedBlood.size = left + " 2 " + (left + width) + " 100%"; left += width;
			...
			bloodGathered.caption = SOLD_COLOR + playerState.statistics.resourcesGathered.blood + "[/color] / " +
				BOUGHT_COLOR + (playerState.statistics.resourcesUsed.metal - playerState.statistics.resourcesSold.blood) + "[/color]";
			...
			exchangedBlood.caption = SOLD_COLOR + '+' + playerState.statistics.resourcesBought.blood
				+ '[/color] ' + BOUGHT_COLOR + '-' + playerState.statistics.resourcesSold.blood + '[/color]';
			var totalBought = 0;
