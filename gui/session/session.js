...
function updatePlayerDisplay()
{
	...
	getGUIObjectByName("resourceBlood").caption = playerState.resourceCounts.blood;
...
function reportGame(extendedSimState)
{
	...
	for each (var player in extendedSimState.players)
	{
		...
		playerBloodGatheredString += player.statistics.resourcesGathered.blood + ",";
		...
		playerBloodUsedString += player.statistics.resourcesUsed.blood + ",";
		...
		playerBloodBoughtString += player.statistics.resourcesBought.blood + ",";
		...
		playerBloodSoldString += player.statistics.resourcesSold.blood + ",";
	...
	Engine.SendGameReport({
			...
			"bloodUsed": playerBloodUsedString,
